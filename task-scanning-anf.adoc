...
Avant de pouvoir analyser des volumes Azure NetApp Files, https://["BlueXP doit être configuré pour détecter la configuration"^].
...
https://["Découvrez comment découvrir le système Azure NetApp Files dans BlueXP"^].
