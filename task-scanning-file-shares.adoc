...
+
Data Sense ne peut pas extraire les autorisations ou l'heure du dernier accès des systèmes 7-mode. En outre, il existe un problème connu dans lequel le montage des partages CIFS sur SMB version 2 n'est pas pris en charge pour Linux.
