...
. Accédez à « /opt/netapp/Datasense » et exécutez le script suivant :
+
...
Pour afficher la liste actuelle des ID de groupe que vous avez ajoutés à la classification BlueXP, exécutez la commande suivante depuis « /opt/netapp/Datase » :
