...
summary: 'Suivez quelques étapes pour déployer Cloud Data SENSE sur un hôte Linux de votre réseau ou sur un hôte Linux dans le cloud disposant d"un accès Internet.' 
---
= Déployez Cloud Data Sense sur un hôte disposant d'un accès Internet
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
[role="lead"]
Suivez quelques étapes pour déployer Cloud Data SENSE sur un hôte Linux de votre réseau ou sur un hôte Linux dans le cloud disposant d'un accès Internet.
...
. Selon que vous déployez une instance dans le cloud ou une instance de votre site, cliquez sur le bouton *déployer* approprié pour démarrer l'assistant de déploiement Data Sense.
+
...
. La boîte de dialogue _Deploy Data Sense on local_ s'affiche. Copiez la commande fournie et collez-la dans un fichier texte afin que vous puissiez l'utiliser ultérieurement, puis cliquez sur *Fermer*. Par exemple :
+
