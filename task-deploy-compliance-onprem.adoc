...
https://youtu.be/gE-vrBLSJqw["Regardez cette vidéo"] Pour voir comment installer la classification BlueXP.
...
+
Notez que le programme d'installation effectue une pré-vérification afin de s'assurer que vos exigences système et réseau sont en place pour une installation réussie. https://youtu.be/UZtn_I0e1Ls["Regardez cette vidéo"] pour comprendre les messages de pré-vérification et les implications.
