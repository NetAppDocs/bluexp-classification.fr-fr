...
* Dans GCP, Cloud Data Sense s'exécute sur un link:https://cloud.google.com/compute/docs/general-purpose-machines#n2_machines["n2-standard-16 VM"^] Avec disque persistant standard de 512 Go. L'image du système d'exploitation est CentOS 7.9.
+
...
| Petit | 8 PROCESSEURS, 16 GO DE RAM, 100 GO DE SSD | Mêmes limites que « Moyen », plus la capacité d'identifier link:task-generating-compliance-reports.html#what-is-a-data-subject-access-request["noms des sujets de données"] les fichiers internes sont désactivés. 
|===
