...
link:task-deploy-compliance-onprem.html#deploy-data-sense-on-premises["En savoir plus sur le déploiement de plusieurs nœuds de numérisation pour analyser vos données"^].
