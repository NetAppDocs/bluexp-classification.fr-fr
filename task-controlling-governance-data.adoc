...
Dans l'onglet _saved recherchs_, les recherches avec le plus grand nombre de résultats apparaissent en haut de la liste.
...
.Étapes
. Dans le menu BlueXP  Classification, sélectionnez *gouvernance*.
. Dans le tableau de bord Goverance, localisez la mosaïque de recherches enregistrées. Sélectionnez le nom d'une recherche enregistrée pour afficher les résultats dans la page Investigation.
