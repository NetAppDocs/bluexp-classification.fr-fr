...
Vous générez ce rapport à partir de l'onglet gouvernance dans Data Sense.
...
.Résultat
Data Sense génère un rapport PDF que vous pouvez examiner et envoyer à d'autres groupes si nécessaire.
