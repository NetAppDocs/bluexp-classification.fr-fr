...
.De formation
* Vous devez disposer des autorisations pour copier des fichiers. link:concept-cloud-compliance.html["En savoir plus sur l'accès des utilisateurs aux informations de conformité"] .
...
.De formation
* Vous devez disposer des autorisations pour copier et synchroniser les fichiers. link:concept-cloud-compliance.html["En savoir plus sur l'accès des utilisateurs aux informations de conformité"] .
* Vous devez sélectionner au moins 20 fichiers.
...
.De formation
* Vous devez disposer des autorisations pour déplacer des fichiers. link:concept-cloud-compliance.html["En savoir plus sur l'accès des utilisateurs aux informations de conformité"] .
...
.De formation
* Vous devez disposer des autorisations pour supprimer des fichiers. link:concept-cloud-compliance.html["En savoir plus sur l'accès des utilisateurs aux informations de conformité"] .
