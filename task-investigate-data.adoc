...
Vous pouvez enregistrer le rapport dans deux formats différents :

* En tant que fichier .CSV vers la machine locale, qui peut inclure jusqu'à 10,000 lignes de données.
* En tant que fichier .JSON que vous exportez vers un partage NFS, qui peut inclure jusqu'à 100,000 lignes de données. S'il y a plus de 100,000 lignes de données, des fichiers .JSON supplémentaires sont créés.
+
