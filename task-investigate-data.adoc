...
. Si vous choisissez CSV comme type de rapport, sélectionnez **local** pour télécharger le rapport dans le navigateur. Remarque cette option limite le rapport aux 10,000 premières lignes. Aucune autre option n'est requise avec cette option.
+
Pour le rapport complet, sélectionnez **Environnement de travail** puis choisissez **Environnement de travail** et **Volume** dans les menus déroulants respectifs. Indiquez un chemin d'accès ** au dossier de destination**.
