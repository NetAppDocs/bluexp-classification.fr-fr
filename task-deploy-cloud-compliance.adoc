...
Les systèmes ONTAP sur site, les partages de fichiers NetApp, le stockage objet générique S3 et les bases de données peuvent être analysés avec l'un de ces connecteurs cloud.
