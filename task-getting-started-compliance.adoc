...
* Pour les systèmes ONTAP sur site, https://["BlueXP doit découvrir les clusters ONTAP"^]
...
Vos systèmes Cloud Volumes ONTAP devraient déjà être disponibles dans la zone de travail de BlueXP. Dont vous avez besoin avec les systèmes ONTAP sur site https://["BlueXP découvre ces clusters"^].
