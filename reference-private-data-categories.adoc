...
[role="lead"]
Il existe de nombreux types de données privées que la classification BlueXP peut identifier dans vos volumes et vos bases de données. Voir les catégories ci-dessous.
