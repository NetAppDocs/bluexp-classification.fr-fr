...
* Vérifiez que votre logiciel BlueXP Connector a été mis à niveau vers la dernière version disponible. https://docs.netapp.com/us-en/cloud-manager-setup-admin/task-managing-connectors.html#upgrade-the-connector-when-using-private-mode["Reportez-vous aux étapes de mise à niveau du connecteur"^].
