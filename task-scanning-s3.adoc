...
+
image:screenshot_s3_enable_compliance.png["Capture d'écran du service Cloud Data Sense dans le panneau Services"]
...
+
image:screenshot_s3_compliance_iam_role.png["Capture d'écran de l'entrée du rôle IAM AWS pour le sens des données cloud"]
